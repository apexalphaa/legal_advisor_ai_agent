...
export const config = {
  ...
  paths: {
    // Vercel's deployed filesystem is not a persistent writable project
    // directory. /tmp is writable for the lifetime of a function instance.
    dataDir:
      process.env.VERCEL === "1"
        ? "/tmp/legal-advisor-ai-agent"
